...
* http://github.com/soldair/node-canvasutil
*
* i did not do any other work than gather and expose these functions in a node module.
*
* Licensed under the MIT license:
*   http://www.opensource.org/licenses/mit-license.php
* 
* these functions were ported to js by:
*
* http://mjijackson.com/2008/02/rgb-to-hsl-and-rgb-to-hsv-color-model-conversion-algorithms-in-javascript
* Copyright © 2008—2010 Michael Jackson.
*/

 var conversionlib = module.exports = {
	rgbToHsl:rgbToHsl,
	hslToRgb:hslToRgb,
	rgbToHsv:rgbToHsv,
	hsvToRgb:hsvToRgb,
